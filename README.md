...
The ancestor's latest substantial work was an acoustic–elastic interface:
captured geometry, repeated-node scattering, a shared 320-incidence table,
operator work/power identities, and coefficient-error bounds. Its full certificate
took 821.696 seconds; wrong indices, normals and weights were rejected.
The useful authoring unit was a small pilot followed by the complete certificate.
