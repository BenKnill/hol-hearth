...
def source_local_needs_prelude(source: Path, *, source_context: Path | None = None) -> list[str]:
    ...
    return [
        ...
        "      proof_run_source_dir_stack := Filename.dirname local_path :: previous_stack;",
        "      try",
